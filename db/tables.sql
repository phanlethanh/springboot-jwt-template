...
(
    role_id character varying(2) COLLATE pg_catalog."default" NOT NULL,
    role_name character varying(128) COLLATE pg_catalog."default",
	privileges character varying(256) COLLATE pg_catalog."default",
...
(
	...
	role_id character varying(2) COLLATE pg_catalog."default",
    create_time timestamp without time zone,
    update_time timestamp without time zone,
